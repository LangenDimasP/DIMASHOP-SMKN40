...
<div class="p-6 max-w-2xl mx-auto">
    <div class="bg-white shadow-lg rounded-xl p-6">
        <h1 class="text-3xl font-bold text-cyan-500 mb-6">Create Voucher</h1>

        <form action="{{ route('admin.vouchers.store') }}" method="POST" id="voucher-form" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <div class="space-y-2">
                    <label class="flex items-center">
                        <input type="radio" name="code_type" value="random" checked class="h-4 w-4 text-cyan-500 focus:ring-cyan-400">
                        <span class="ml-2">Generate Random Code</span>
                    </label>
                    <label class="flex items-center">
                        <input type="radio" name="code_type" value="manual" class="h-4 w-4 text-cyan-500 focus:ring-cyan-400">
            ...
            <div>
                ...
                <input type="number" name="min_order" id="min_order" step="0.01"
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
            ...
            <div class="pt-2">
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" checked class="h-4 w-4 text-cyan-500 rounded focus:ring-cyan-400">
            ...
            <div>
                ...
                <input type="number" name="points_required" id="points_required" min="0"
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
            ...
            <div class="pt-2">
                <label class="flex items-center">
                    <input type="checkbox" name="is_redeemable_with_points" value="1" class="h-4 w-4 text-cyan-500 rounded focus:ring-cyan-400">
