    ...
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            <div class="mb-6">
                ...
                <p class="text-gray-600 mt-1 text-sm sm:text-base">Tambah, edit, dan hapus promo</p>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse($promos as $promo)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 flex gap-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.promos.destroy', $promo) }}" onsubmit="return confirm('Hapus promo ini?')" class="inline">
                                            @csrf @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 py-4 text-center text-gray-500">Belum ada promo</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
